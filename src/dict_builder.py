...
class LanguageDetector(object):
    ...
    def write_dictionaries(self):
        with open('idf.dict', 'w') as outfile:
            json.dump(self.idfs, outfile)
        with open('weights.dict', 'w') as outfile:
            json.dump(self.weights, outfile)


ld = LanguageDetector()
ld.calculate_frequencies()
ld.calculate_inverse_document_frequency()
ld.calculate_weights()
